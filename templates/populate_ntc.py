...
if (total_counts == 0).any():
    zero_count_guides = total_counts.loc[total_counts == 0].index.values
    print(f"Removing {zero_count_guides.shape[0]:,} guides with 0 counts")

    counts = counts.drop(
        index=zero_count_guides
    )
